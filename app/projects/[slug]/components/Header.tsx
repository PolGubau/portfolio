      ...
      <nav className="w-full flex flex-wrap gap-4">
        {p.link && (
          ...
          >
            ...
            <svg xlinkTitle="Link to the project" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
        ...
        {p.githubLink && (
          <Link
            ...
            rel="noopener noreferrer"
          >
            <svg xlinkTitle="Link to Github Source" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
              <g fill="none">
        ...
        {p.npmLink && (
          <Link
            ...
            rel="noopener noreferrer"
          >
            <svg xlinkTitle="Link to NPM Package" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
              <path fill="#000000" fillRule="evenodd" d="M5 21a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5Zm1-3V6h12v12h-3V9h-3v9H6Z" clipRule="evenodd" />
            </svg>
