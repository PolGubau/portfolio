...
const Header = () => {
  return (
    <header className="flex flex-col md:flex-row gap-8 justify-between items-center mb-16">
      <Image src="/images/me.png" className=" rounded-3xl flex md:hidden bg-primary   " alt="Pol Gubau Amores' profile image" title="Pol Gubau Amores' profile image" width={ 150 } height={ 150 } />
      ...
      <Image placeholder={ largeProfileAvatar } src="/images/me.png" className="shadow-xl rounded-full hidden md:flex   bg-primary " alt="Pol Gubau Amores' profile image" width={ 150 } height={ 150 } title="Pol Gubau Amores' profile image" />
    </header>
  );
};
