...
<section className="flex gap-4 show-animation">
   <Image
  src="/images/projects/trackup/1.webp"
  alt="TrackUp"
  width={300}
  height={500}      
  className="h-[500px] rounded-xl object-cover show-animation"
  />
   <Image
  src="/images/projects/trackup/2.webp"
  alt="TrackUp"
  width={300}
  height={500}      
  className="h-[500px] rounded-xl object-cover show-animation"
  />
   <Image
  src="/images/projects/trackup/3.webp"
  alt="TrackUp"
  width={300}
  height={500}      
  className="h-[500px] rounded-xl object-cover show-animation"
