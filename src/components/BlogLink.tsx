...
export function BlogLink({ slug, name, children, className }: Readonly<BlogLinkProps>) {
  return (
    <Link
      ...
      hrefLang="en-us"
      className={cn(
        "group flex w-full flex-1 select-none items-center justify-between gap-6 rounded-2xl bg-secondary-900/10 px-5 py-4 text-balanced transition-all hover:bg-secondary-900/20 hover:brightness-125 md:p-6 dark:bg-secondary-100/10 dark:hover:bg-secondary-50/20",
        className,
      )}
    >
