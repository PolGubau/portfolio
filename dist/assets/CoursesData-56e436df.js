import{s,z as d,R as u,L as p,g as m,j as a,c as g,F as h,G as b,e as v,p as f,T as w,d as y,f as S,H as k,I as x,J as z,K as A,M as j,N as q,O as D}from"./index-3ceeb06c.js";const E=(e,i)=>{const n=Math.round(i*255).toString(16);return e+n},T=s(d)`
  display: flex;
...
`,o=()=>{const e=localStorage.getItem("context");return e?JSON.parse(e).blogsAlreadyRead:[]},l=e=>o().includes(e),M=e=>{const i=o();i.push(e.id),localStorage.setItem("context",JSON.stringify({blogsAlreadyRead:i}))},Oe=e=>{l(e.id)||M(e)},R=({course:e})=>{const i=u(p),n=m(i.code,e.name),c=`/courses/${e.path}`;return a.jsxs(T,{to:c,color:e.color?e.color:g.colors.blue,children:[l(e.id)&&a.jsx("span",{className:"seenCheck",children:a.jsx(h,{size:40})}),a.jsx("p",{className:"name",children:n}),a.jsx(I,{children:a.jsx("span",{className:"bigIcon",children:e.icon?e.icon:""})})]})},C=s.section`
  ...
  gap: 20px;
`,Ke=({blogs:e,narrowLayout:i=!1})=>a.jsx(C,{narrowLayout:i,children:e.map(n=>a.jsx(R,{course:n},n.id))});function J(e){return b({tag:"svg",attr:{role:"img",viewBox:"0 0 24 24"},child:[{tag:"title",attr:{},child:[]},{tag:"path",attr:{d:"M12 0C5.377 0 0 5.377 0 12s5.377 12 12 12 12-5.377 12-12S18.623 0 12 0zm0 .75c2.871 0 5.482 1.082 7.469 2.85H4.53A11.197 11.197 0 0 1 12 .75zm-7.186 3.6h14.372L12 18.723 4.814 4.35zM3.6 4.53V19.47A11.197 11.197 0 0 1 .75 12c0-2.87 1.082-5.481 2.85-7.468zm16.8 0A11.197 11.197 0 0 1 23.25 12c0 2.871-1.082 5.482-2.85 7.469V4.53zM4.35 5.1l7.275 14.55H4.35V5.1zm15.3 0v14.55h-7.275L19.651 5.1zM4.533 20.4H19.469A11.197 11.197 0 0 1 12 23.25a11.197 11.197 0 0 1-7.468-2.85z"}}]})(e)}const L=`
...
`,Me=`# **An Introduction to Bootstrap**
...
`,Re=`# **Una introducción a Bootstrap**
...
`,Ce={en:Me,es:Re,ca:Te,de:Ie},Je=`# **Introducció**
