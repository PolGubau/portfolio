import{s,m as d,R as c,L as l,g as r,j as e,G as k,W as V,u as x,r as I,a as C,b as z,c as u,T as L,d as S,e as D,f as $,h as E,i as H,k as B,l as N,n as A,o as P,p as R,q as U,S as p,t as q,v as W}from"./index-3ceeb06c.js";import{R as j}from"./react-markdown-f7e94505.js";const G=s.main`
  width: 100%;
  position: relative;
  display: flex;
...
`,s1=[e.jsx(L,{size:30}),e.jsx(S,{size:30}),e.jsx(D,{size:30}),e.jsx($,{size:30}),e.jsx(E,{size:30}),e.jsx(H,{size:30}),e.jsx(B,{size:30}),e.jsx(N,{size:30}),e.jsx(A,{size:30}),e.jsx(P,{size:30}),e.jsx(R,{size:30}),e.jsx(U,{size:30})],c1=()=>{const a=c(l),n=r(a.code,h);return e.jsxs(n1,{children:[e.jsx("p",{children:n.someTechnologies}),e.jsx("section",{children:s1.map((i,t)=>e.jsx("div",{children:i},t))})]})},l1=s.div`
  max-width: 90vw;
  width: 90%;
  display: flex;
  flex-direction: column;
